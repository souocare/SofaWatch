...
def test_poster_url_returns_endpoint() -> None:
    ...
    assert show.poster_url == ("/api/v1/images/shows/12345678-1234-1234-1234-123456789abc/poster")
...
def test_backdrop_url_returns_endpoint() -> None:
    ...
    assert show.backdrop_url == (
        "/api/v1/images/shows/12345678-1234-1234-1234-123456789abc/backdrop"
    )
